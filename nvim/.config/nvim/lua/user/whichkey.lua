...
local mappings = {
  ...
  z = {
    name = "Zk",
    b = { "<cmd>ZkBacklinks<cr>", "b-links" },
    c = { "<cmd>ZkCd<cr>", "cd" },
    g = { "<cmd>lua vim.lsp.buf.definition()<cr>", "goto" },
    k = { "<cmd>ZkNotes { sort = { 'modified' } }<cr>", "kasten" },
  ...
  [";"] = {
    name = "Terminal",
    d = { "<cmd>lua _DUST_TOGGLE()<cr>", "Dust" },
    t = { "<cmd>lua _HTOP_TOGGLE()<cr>", "Htop" },
    j = { "<cmd>lua _JULIA_TOGGLE()<cr>", "Julia" },
    n = { "<cmd>lua _NODE_TOGGLE()<cr>", "Node" },
    p = { "<cmd>lua _PYTHON_TOGGLE()<cr>", "Python" },
    s = { "<cmd>lua _TOKEI_TOGGLE()<cr>", "Stats" },
